namespace CruiseShipStatusDisplay
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            numericUpDown1.Location = new Point(116, 105);
            ...
            numericUpDown2.Location = new Point(187, 105);
            ...
            contextMenuStrip1.Items.AddRange(new ToolStripItem[] { ts1, ts2, ts3, ts4, ts5, ts6, ts7, ts8, toolStripMenuItem1, ts21 });
            contextMenuStrip1.Name = "contextMenuStrip1";
            contextMenuStrip1.ShowImageMargin = false;
            contextMenuStrip1.Size = new Size(242, 224);
            contextMenuStrip1.Text = "選択";
            // 
            // ts1
            // 
            ts1.Name = "ts1";
            ts1.Size = new Size(241, 22);
            ts1.Text = "Route Display";
            ts1.ToolTipText = "306";
            ts1.Click += TSMI7C;
            ...
            // 
            ts2.Name = "ts2";
            ts2.Size = new Size(241, 22);
            ts2.Text = "Text Display";
            ts2.Click += TSMI8C;
            ...
            // 
            ts3.Name = "ts3";
            ts3.Size = new Size(241, 22);
            ts3.Text = "Work Panel Display";
            ...
            ts4.Size = new Size(241, 22);
            ts4.Text = "Control Panel (win)";
            ts4.Click += tsmic6;
            ...
            ts5.Size = new Size(241, 22);
            ts5.Text = "Explorer (Folder)";
            ts5.Click += tsmic7;
            ...
            // 
            ts70.Name = "ts70";
            ts70.Size = new Size(146, 22);
            ts70.Text = "1 minute later";
            ...
            // 
            ts71.Name = "ts71";
            ts71.Size = new Size(146, 22);
            ts71.Text = "3 minute later";
            ...
            ts8.Size = new Size(241, 22);
            ts8.Text = "Shut down this app.";
            ts8.Click += tsmicC;
            ...
            toolStripMenuItem1.Size = new Size(241, 22);
            toolStripMenuItem1.Text = "Other Features";
            toolStripMenuItem1.MouseEnter += TSMI7ME1;
            toolStripMenuItem1.MouseLeave += TSMI7ML;
            // 
            // contextMenuStrip2
            // 
            contextMenuStrip2.Items.AddRange(new ToolStripItem[] { ts17, ts17A, ts18, ts19, ts16, 本体表示切替ToolStripMenuItem });
            contextMenuStrip2.Name = "contextMenuStrip2";
            contextMenuStrip2.OwnerItem = toolStripMenuItem1;
            contextMenuStrip2.ShowImageMargin = false;
            contextMenuStrip2.Size = new Size(210, 136);
            ...
            ts17.Name = "ts17";
            ts17.Size = new Size(209, 22);
            ts17.Text = "Activate window with mouse";
            ...
            // 
            ts17A.Name = "ts17A";
            ts17A.Size = new Size(209, 22);
            ts17A.Text = "Fixed position";
            ts17A.Click += tSMI2C;
            ...
            // 
            ts18.Name = "ts18";
            ts18.Size = new Size(209, 22);
            ts18.Text = "Change the look to dark mode";
            ...
            // 
            ts19.Name = "ts19";
            ts19.Size = new Size(209, 22);
            ts19.Text = "Change the look to light mode";
            ...
            ts16.Name = "ts16";
            ts16.Size = new Size(209, 22);
            ts16.Text = "Font (beta,No preservation)";
            ...
            // 
            ts60.Name = "ts60";
            ts60.Size = new Size(211, 22);
            ts60.Text = "color change dialog";
            ts60.Click += tsmic4;
            ...
            // 
            ts61.Name = "ts61";
            ts61.Size = new Size(211, 22);
            ts61.Text = "font change dialog";
            ts61.Click += tsmic5;
            ...
            // 
            ts62.Name = "ts62";
            ts62.Size = new Size(211, 22);
            ts62.Text = "Initial appearance settings";
            ...
            本体表示切替ToolStripMenuItem.Size = new Size(209, 22);
            本体表示切替ToolStripMenuItem.Text = "skins, etc. (beta)";
            // 
            // ts041
            // 
            ts041.Name = "ts041";
            ts041.Size = new Size(228, 22);
            ts041.Text = "standard equipment";
            ts041.Click += ts041_Click;
            // 
            // ts042
            // 
            ts042.Name = "ts042";
            ts042.Size = new Size(228, 22);
            ts042.Text = "square corners Win10 style";
            ts042.Click += ts042_Click;
            // 
            // ts043
            // 
            ts043.Name = "ts043";
            ts043.Size = new Size(228, 22);
            ts043.Text = "rounded corners win11 only";
            ts043.Click += ts043_Click;
            // 
            // 透過表示ToolStripMenuItem
            // 
            透過表示ToolStripMenuItem.Name = "透過表示ToolStripMenuItem";
            透過表示ToolStripMenuItem.Size = new Size(228, 22);
            透過表示ToolStripMenuItem.Text = "display this app transparently";
            透過表示ToolStripMenuItem.Click += 透過表示ToolStripMenuItem_Click;
            // 
            // toolStripMenuItem2
            // 
            toolStripMenuItem2.Name = "toolStripMenuItem2";
            toolStripMenuItem2.Size = new Size(228, 22);
            toolStripMenuItem2.Text = "transparency end";
            ...
            ts21.Size = new Size(241, 22);
            ts21.Text = "Close this menu";
            ts21.Click += TSMI5C;
            ...
            label4.Font = new Font("MS UI Gothic", 9F, FontStyle.Bold, GraphicsUnit.Point, 128);
            label4.Location = new Point(8, 141);
            label4.Margin = new Padding(4, 0, 4, 0);
            label4.Name = "label4";
            label4.Size = new Size(99, 12);
            label4.TabIndex = 4;
            label4.Text = "meas. date,time";
            ...
            button1.Location = new Point(157, 66);
            button1.Margin = new Padding(4, 2, 4, 2);
            button1.Name = "button1";
            button1.Padding = new Padding(2, 2, 0, 0);
            button1.Size = new Size(99, 23);
            button1.TabIndex = 4;
            button1.Text = "m.d,t Rec";
            ...
            label6.Location = new Point(230, 111);
            label6.Margin = new Padding(4, 0, 4, 0);
            label6.Name = "label6";
            label6.Size = new Size(25, 12);
            label6.TabIndex = 18;
            label6.Text = "sec.";
            // 
            // label7
            ...
            label7.Location = new Point(159, 111);
            label7.Margin = new Padding(4, 0, 4, 0);
            label7.Name = "label7";
            label7.Size = new Size(25, 12);
            label7.TabIndex = 17;
            label7.Text = "min.";
            // 
            // progressBar1
            ...
            numericUpDown3.Increment = new decimal(new int[] { 2, 0, 0, 196608 });
            numericUpDown3.Location = new Point(124, 174);
            numericUpDown3.Margin = new Padding(4, 2, 4, 2);
            numericUpDown3.Maximum = new decimal(new int[] { 9999, 0, 0, 196608 });
            numericUpDown3.Name = "numericUpDown3";
            numericUpDown3.Size = new Size(50, 19);
            ...
            comboBox1.Items.AddRange(new object[] { "Two Crowns", "Solis Headlands" });
            comboBox1.Location = new Point(8, 68);
            comboBox1.Name = "comboBox1";
            comboBox1.Size = new Size(142, 20);
            ...
            label16.Location = new Point(8, 176);
            label16.Margin = new Padding(4, 0, 4, 0);
            label16.Name = "label16";
            label16.Size = new Size(103, 12);
            label16.TabIndex = 39;
            label16.Text = "delay correction";
            // 
            // progressBar2
            // 
            ...
            label18.Location = new Point(10, 206);
            ...
            label19.Font = new Font("MS UI Gothic", 9F, FontStyle.Regular, GraphicsUnit.Point, 128);
            label19.Location = new Point(193, 176);
            ...
            pictureBox182.Image = Properties.Resources.map1;
            ...
            // pictureBox1
            // 
            pictureBox1.Location = new Point(176, 206);
            pictureBox1.Name = "pictureBox1";
            pictureBox1.Size = new Size(78, 11);
            ...
            comboBox2.Items.AddRange(new object[] { "m.d,t Button Disable", "m.d,t Button Enable" });
            comboBox2.Location = new Point(58, 225);
            comboBox2.Name = "comboBox2";
            comboBox2.Size = new Size(153, 20);
